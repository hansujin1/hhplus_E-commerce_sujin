...
public class PointHisDataInitializer {
    ...
    public void init(){
        ...
        pointHisRepository.save(new PointHis(null,20250202L, PointType.CHARGE,150_000));
        pointHisRepository.save(new PointHis(null,20250202L,PointType.USE,50_000));

        log.info("User의 포인트 이력 정보 초기 셋팅하기 - 정호석");
        pointHisRepository.save(new PointHis(null,20250222L,PointType.CHARGE,150_000));
        pointHisRepository.save(new PointHis(null,20250222L,PointType.USE,25_000));
        pointHisRepository.save(new PointHis(null,20250222L,PointType.USE,12_000));
    }
